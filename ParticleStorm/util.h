...
public:
    ...
    static Point2D randCoordOnRect(double x1, double y1, double x2, double y3);

    //calculate the intersection point between 2 lines (if any)
    static Point2D* lineIntersect(const double x1, const double y1, const double x2, const double y2,
